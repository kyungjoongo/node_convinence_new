...
var route_naver_image_search_api = require('./routes/new_route/route_naver_image_search_api');
...
var aution_route = require('./routes/auction_route/aution_route');
var route_youtube_list = require('./routes/new_route/route_youtube_list');
var route_sarain = require('./routes/new_route/route_sarain');
//var firebase_crud_route = require('./routes/new_route/firebase_crud_route');
var route_youtube_to_mp3_ = require('./routes/new_route/route_youtube_to_mp3_');

var route_english_content_ = require('./routes/new_route/route_english_content_');


var firebase_route = require('./routes/firebase_route/firebase_route');
...
app.use('/', aution_route)
app.use('/', route_youtube_list)
app.use('/', route_english_content_)

//app.use('/', firebase_crud_route);

app.use('/', route_sarain)

//route_dr_apt_best_bunyang
app.use('/', route_dr_apt_best_bunyang)
app.use('/', route_dr_apt)
//route_naver_image_search_api
app.use('/', route_naver_image_search_api)
...
app.use('/', route_youtube_to_mp3_)
app.use('/', firebase_route)
