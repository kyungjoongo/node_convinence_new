...
function fetchAndpushFcm(){
    ...
    //todo: array 1번째 데이타
    //todo: array 1번째 데이타nth-child(2)
    //todo: array 1번째 데이타routes/temp/node_schduler00000002_thats_right_스케쥴러.js:39
    var rand_no = getRandomInt(20);
...
// set target users
//firstNotification.postBodimport androidx.annotation.Nullable;y["headings"] = {"en": "English Title"};
